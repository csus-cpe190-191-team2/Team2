...
def initialize_trackbars(init_trackbar_vals, w_t=480, h_t=240):
    ...
    init_tools = init_trackbar_vals[2]
    ...
    # Image Hough transform and save sliders
    cv2.namedWindow("Tools")
    cv2.resizeWindow("Tools", w_t, h_t)
    cv2.createTrackbar("Hough Threshold", "Tools", init_tools[0], 250, empty)
    cv2.createTrackbar("Hough Max Gap", "Tools", init_tools[1], 500, empty)
...
if __name__ == '__main__':
    ...
    init_trackbar_vals = [warp_points, thresh_points, hough_points]  # DEFAULT: 0,0,0,200
